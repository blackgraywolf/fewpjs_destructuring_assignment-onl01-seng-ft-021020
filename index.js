...
// 1. Use destructuring to assign appropriate variables based on the sounds 1. 
const [moo, bark, naa, oink, cherp] = 'cow dog sheep pig bird'.split(" ")
// 2. Bolt the horse wandered off, so just give us four animals, and let's name them Bessie, Dolly, Babe, and Little.
const [Bob, Bobby, Bobolishos, Bobsy] = 'cow dog sheep pig'.split(" ")
